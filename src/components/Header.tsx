...
const Header = () => {
  return (
    <header className='fixed inset-x-0 top-0 z-10 grid h-[60px] w-screen grid-cols-[1fr_1.5fr_1fr] gap-x-6 border-b bg-white px-6 xl:gap-x-12 xl:px-12'>
      <div className='flex items-center'>
        <Link href={ROUTES.HOME} className='flex items-center gap-x-1.5'>
          ...
          <Image src={Logo} draggable={false} alt='logo' className='h-[22.5px] w-[110px]' />
        </Link>
      </div>
